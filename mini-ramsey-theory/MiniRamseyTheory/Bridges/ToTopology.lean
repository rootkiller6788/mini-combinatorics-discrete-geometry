/-
# Ramsey Theory -> Topology
Knowledge coverage: L7
-/
import MiniRamseyTheory.Core.Basic
namespace MiniRamseyTheory

axiom BrTo_EllentuckTopology : Type
axiom BrTo_ellentuck_is_polish : True
axiom BrTo_GalvinPrikryStatement : Prop
axiom BrTo_galvin_prikry_theorem : BrTo_GalvinPrikryStatement
axiom BrTo_silverTheorem : True
axiom BrTo_nashWilliamsTheorem : True

class TopologicalRamseySpace (R : Type) where
  basicOpen : R → Prop
  axiom1 : basicOpen = basicOpen
